        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tr>
                    ...
                    <th scope="col" class="px-6 py-4 text-left text-xs font-bold text-white uppercase tracking-wider font-outfit cursor-pointer" wire:click="sortBy('name')">
                        Name
                    </th>
                    <th scope="col" class="px-6 py-4 text-left text-xs font-bold text-white uppercase tracking-wider font-outfit cursor-pointer" wire:click="sortBy('status')">
                        Status
                    </th>
                ...
                @forelse ($states as $state)
                    <tr wire:key="state-{{ $state->id }}" class="odd:bg-white even:bg-impetus-teal-muted/50 hover:bg-brand-50/80 transition-colors">
