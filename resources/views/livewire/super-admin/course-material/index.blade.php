    ...
    <div class="bg-white shadow-md rounded-lg p-6 mb-6 dark:bg-gray-800">
        <div class="flex flex-wrap items-center gap-4">
            ...
            <div class="flex items-center gap-2 flex-shrink-0">
                ...
                <button type="button" wire:click="setFilter('active')" wire:key="filter-active"
                ...
                <button type="button" wire:click="setFilter('inactive')" wire:key="filter-inactive"
                    wire:loading.attr="disabled"
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gradient-to-r from-impetus-teal to-impetus-orange text-white">
                    <tr>
                        <th scope="col"
                            class="px-6 py-4 text-left text-xs font-bold text-white uppercase tracking-wider font-outfit cursor-pointer"
                    ...
                    <th scope="col" class="px-6 py-4 text-left text-xs font-bold text-white uppercase tracking-wider font-outfit cursor-pointer" wire:click="sortBy('active_status')">
                        ...
                        @if (in_array($routePrefix, ['super-admin', 'admin']))
                            <th scope="col"
                                class="px-6 py-4 text-right text-xs font-bold text-white uppercase tracking-wider font-outfit">
                                Action
                            </th>
                        @endif
                    </tr>
                ...
                <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                        ...
                                        @foreach ($material->attachment as $path)
                                            ...
                                            <li class="inline-flex">
                                                <a href="{{ asset('storage/' . $path) }}" target="_blank"
                                                    class="inline-flex items-center gap-2 rounded-md border border-slate-200 bg-slate-100 px-2.5 py-1 text-blue-600 hover:bg-slate-200 hover:text-blue-900 dark:border-gray-600 dark:bg-gray-700 dark:text-blue-400 dark:hover:bg-gray-600 dark:hover:text-blue-300">
                                                    @if ($extension === 'pdf')
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                d="M19.5 8.25V19.5a2.25 2.25 0 01-2.25 2.25H6.75A2.25 2.25 0 014.5 19.5v-15A2.25 2.25 0 016.75 2.25h7.5L19.5 8.25z" />
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                d="M14.25 2.25V8.25H19.5" />
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                d="M8.25 16.5h7.5M8.25 13.5h4.5" />
                                                        </svg>
                                                    @elseif(in_array($extension, ['ppt', 'pptx']))
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                d="M14.25 2.25V8.25H19.5" />
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                d="M9 16.5v-4.5h3a2.25 2.25 0 010 4.5H9zM15.75 12v4.5" />
                                                        </svg>
                                                    @else
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            @if (in_array($routePrefix, ['super-admin', 'admin']))
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <form
                                            action="{{ route($routePrefix . '.title-materials.destroy', $material) }}"
                                            method="POST" class="inline"
                                            onsubmit="return confirm('Are you sure you want to delete this resources?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                    ...
                    @empty
                        <tr>
                            <td colspan="{{ in_array($routePrefix, ['super-admin', 'admin']) ? 6 : 5 }}"
