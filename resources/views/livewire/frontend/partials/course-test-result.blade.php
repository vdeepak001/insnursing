...
<div class="mx-auto max-w-5xl rounded-3xl border border-slate-200 bg-white shadow-2xl ring-1 ring-slate-900/5"
    ...
    {{-- ══════════════════════════════════════════
         ...
         ══════════════════════════════════════════ --}}
    <div
        class="grid gap-6 border-t border-slate-100 bg-slate-50/40 px-6 py-8 sm:px-8 @if ($showFeedback) lg:grid-cols-2 @endif">
        {{-- Performance summary --}}
                            ...
                            <button type="button" @click="$wire.setRating({{ $i }})"
                                ...
                                <svg class="size-10 transition-colors sm:size-11"
                                    :class="(hoverRating || currentRating) >= {{ $i }} ?
                                        'text-impetus-orange fill-impetus-orange' : 'text-slate-300 fill-transparent'"
                    ...
                    <div class="mt-8 border-t border-slate-100 pt-6">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-slate-500">Download your {{ $banner }} completion
                                    certificate.</p>
                            </div>
                        </div>
