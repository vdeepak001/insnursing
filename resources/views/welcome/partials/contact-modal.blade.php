        ...
        <div class="grid grid-cols-1 md:grid-cols-5">
            ...
            <div class="md:col-span-3 p-6 sm:p-8 flex flex-col justify-between">
                <div class="mb-5 flex items-start justify-between gap-4">
                    <div>
                        <h2 id="contact-modal-title" class="font-serif text-2xl font-bold text-slate-900 mb-1">Contact
                            Us</h2>
                        <p class="text-xs sm:text-sm text-slate-600">Send us an inquiry and we'll get back to you
                            shortly.</p>
                    </div>
                ...
                <form method="POST" action="{{ route('contact.submit') }}" class="space-y-4">
                    ...
                    <div>
                        <label for="contact-name"
                            class="mb-1 block text-xs font-bold text-slate-700 uppercase tracking-wider font-outfit">Name
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label for="contact-email"
                                class="mb-1 block text-xs font-bold text-slate-700 uppercase tracking-wider font-outfit">Email
                                ID <span class="text-rose-500 font-bold">*</span></label>
                        ...
                        <div>
                            <label for="contact-mobile"
                                class="mb-1 block text-xs font-bold text-slate-700 uppercase tracking-wider font-outfit">Mobile
                                # <span class="text-rose-500 font-bold">*</span></label>
                            <input type="text" id="contact-mobile" name="mobile"
                                value="{{ auth()->check() ? auth()->user()->phone : old('mobile') }}" required
                                class="block w-full rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:border-impetus-orange focus:outline-none focus:ring-2 focus:ring-impetus-orange/25" />
                    ...
                    <div>
                        <label for="contact-ihsid"
                            class="mb-1 block text-xs font-bold text-slate-700 uppercase tracking-wider font-outfit">IHSID
                            <span class="text-slate-400 text-xs font-normal">(Optional)</span></label>
                        <input type="text" id="contact-ihsid" name="ihsid"
                    ...
                    <div>
                        <label for="contact-query"
                            class="mb-1 block text-xs font-bold text-slate-700 uppercase tracking-wider font-outfit">Query
                            for <span class="text-rose-500 font-bold">*</span></label>
                        <textarea id="contact-query" name="query_for" required rows="3"
            ...
            <div
                class="md:col-span-2 bg-gradient-to-br from-[#045A5D] to-impetus-navy text-white p-6 sm:p-8 flex flex-col justify-between relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-xs sm:text-sm text-slate-300 leading-relaxed mb-8 font-outfit">Feel free to reach
                ...
                <div
                    class="mt-12 pt-4 border-t border-white/5 text-[10px] text-slate-400 font-outfit relative z-10 leading-normal">
