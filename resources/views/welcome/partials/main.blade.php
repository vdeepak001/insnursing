<main class="font-sans antialiased text-slate-800">
        ...
        <div class="relative mx-auto max-w-7xl px-6 sm:px-8">
            <div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
                <div class="text-center lg:text-left">
                    ...
                    <h1 class="text-4xl font-extrabold leading-tight tracking-tight text-slate-800 sm:text-5xl lg:text-[3.25rem] font-outfit">
                        Professional eLearning Engineered for
                        <span class="text-impetus-teal">Clinical Impact</span><span class="text-impetus-orange">.</span>
                    </h1>
                    ...
                    <ul class="mt-8 space-y-3 text-left">
                        @foreach ([
                            '26+ CNE Modules with evidence-based curriculum',
                            'Innovative outcome-oriented training programs',
                            'Clinical practice excellence and patient safety focus',
                            '100% accredited course content for healthcare professionals',
                        ] as $bullet)
                            <li class="flex items-start gap-3 text-sm text-slate-600 sm:text-base">
                                <span class="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-impetus-teal text-white">
                    ...
                    <div class="mt-8 flex flex-col gap-4 sm:flex-row sm:justify-start sm:justify-center lg:justify-start">
                ...
                <div class="relative mx-auto flex w-full max-w-md items-center justify-center lg:max-w-none">
                    ...
                    <div class="absolute -right-1 top-10 flex h-10 w-10 items-center justify-center rounded-full bg-impetus-orange text-white shadow-md">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.147a60.438 60.438 0 00-.491 6.347A48.62 48.62 0 0112 20.904a48.62 48.62 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.636 50.636 0 00-2.658-.813A59.906 59.906 0 0112 3.493a59.903 59.903 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0112 13.489a50.702 50.702 0 017.74-3.342" />
                        </svg>
                    </div>
                    <div class="absolute right-6 top-1/2 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-impetus-orange text-white shadow-md">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
                        </svg>
                    </div>
                    <div class="absolute bottom-12 left-0 flex h-10 w-10 items-center justify-center rounded-full bg-impetus-orange text-white shadow-md">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681 2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" />
                        </svg>
                    </div>
                    <div class="absolute bottom-6 right-10 flex h-10 w-10 items-center justify-center rounded-full bg-impetus-orange text-white shadow-md">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="mx-auto max-w-7xl px-6 sm:px-8">
            <div class="grid grid-cols-2 gap-6 text-center text-white md:grid-cols-5 md:gap-4">
                @foreach ([
                    ...
                    <div @class(['flex flex-col items-center gap-2', 'col-span-2 md:col-span-1' => $loop->last && $loop->count % 2 !== 0])>
                        ...
                        <p class="text-[11px] font-semibold uppercase tracking-wide text-white/90 sm:text-xs">{{ $stat['label'] }}</p>
                    </div>
                @endforeach
            </div>
        </div>
    ...
    <section id="vision-mission" class="bg-impetus-teal-muted py-24">
        <div class="mx-auto max-w-7xl px-6 sm:px-8">
            ...
            <div class="overflow-hidden rounded-2xl border border-impetus-teal/10 shadow-sm lg:flex">
                {{-- Our Vision --}}
                <article class="flex flex-1 gap-5 bg-impetus-lightOrange p-8 sm:gap-6 sm:p-10 lg:border-r lg:border-impetus-orange/20">
                    <div class="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-impetus-orange/15 text-impetus-orange sm:h-16 sm:w-16">
                        <svg class="h-7 w-7 sm:h-8 sm:w-8" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
                    ...
                    <div class="min-w-0">
                        <h3 class="text-base font-extrabold uppercase tracking-wide text-impetus-orange sm:text-lg font-outfit">
                            Our Vision
                        </h3>
                ...
                {{-- Our Mission --}}
                <article class="flex flex-1 gap-5 border-t border-impetus-teal/15 bg-impetus-teal-muted p-8 sm:gap-6 sm:p-10 lg:border-t-0">
                    <div class="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-impetus-teal/10 text-impetus-teal sm:h-16 sm:w-16">
                        <svg class="h-7 w-7 sm:h-8 sm:w-8" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
                    ...
                    <div class="min-w-0">
                        <h3 class="text-base font-extrabold uppercase tracking-wide text-impetus-teal sm:text-lg font-outfit">
                            Our Mission
                        </h3>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="grid grid-cols-1 items-center gap-y-12 lg:grid-cols-12 lg:gap-x-16">
                <div class="lg:col-span-7">
                    <h2 class="mb-3 text-base font-bold uppercase tracking-widest text-impetus-orange font-outfit">About IHS</h2>
    ...
    <section id="our-values" class="bg-impetus-teal-muted py-24">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <h2 class="mb-12 text-center text-3xl font-extrabold uppercase tracking-widest text-impetus-teal sm:text-4xl font-outfit">
                Our Values
            </h2>
            <div class="relative">
                <div class="absolute left-8 right-8 top-8 hidden h-px border-t border-dashed border-impetus-teal/25 lg:block"></div>
    ...
    <section class="relative border-b border-impetus-teal/10 bg-white py-16 sm:py-24">
        <div class="pointer-events-none absolute right-0 top-0 h-64 w-64 rounded-full bg-impetus-orange/5 blur-[100px]"></div>
        ...
        <div class="relative mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                @foreach ([
                    ...
                    @endphp
                    <div class="flex items-start gap-3 rounded-xl border border-impetus-teal/10 bg-white p-4 shadow-sm transition hover:border-impetus-teal/25 hover:shadow-md">
                        <div @class([
                        ...
                        <div class="min-w-0">
                            <h3 class="text-sm font-bold leading-snug text-impetus-teal font-outfit">{{ $strength['title'] }}</h3>
            ...
            <div class="mt-4 flex items-start gap-4 rounded-xl bg-impetus-teal p-5 sm:items-center sm:p-6">
                <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-md bg-impetus-orange text-white shadow-md">
                ...
                <div class="min-w-0">
                    <h3 class="text-base font-bold text-white font-outfit sm:text-lg">Commitment to Quality Healthcare Education</h3>
    ...
    <section id="cne-modules" class="relative overflow-hidden bg-white py-24">
        <div class="pointer-events-none absolute left-0 top-0 h-64 w-64 rounded-full bg-impetus-teal/5 blur-[80px]"></div>
        <div class="mx-auto max-w-7xl px-6 sm:px-8">
            <h2 class="mb-12 text-center text-3xl font-extrabold uppercase tracking-widest text-impetus-teal sm:text-4xl font-outfit">
                CNE Modules
            </h2>
            ...
            @if ($latestCourses->isEmpty())
                <div class="rounded-2xl border border-impetus-teal/10 bg-impetus-teal-muted px-8 py-12 text-center">
                    <p class="text-base leading-relaxed text-slate-600">No modules are available yet. Please check back later.</p>
                </div>
            @else
                <div
                    x-data="{
