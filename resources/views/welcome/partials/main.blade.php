<main class="font-sans antialiased text-slate-800">
    ...
    <section class="bg-impetus-teal py-4 sm:py-6">
        ...
        ['icon' => 'M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z', 'value' => '1.3 Lakhs+', 'label' => 'Certificate Issued'],
        ['icon' => 'M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z', 'value' => '100%', 'label' => 'Accredited Modules'],
    ...
    <section id="our-values" class="bg-impetus-teal-muted py-16">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <h2
                class="mb-12 text-center text-3xl font-extrabold uppercase tracking-widest !text-impetus-orange sm:text-4xl font-outfit">
                Our Values
            </h2>
            <div class="relative">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    @foreach ([
        ['title' => 'Ethical Values', 'text' => 'We are committed to upholding the highest ethical standards in healthcare education and professional practice. We promote honesty, fairness, respect, confidentiality, and accountability in all our activities. By fostering ethical behavior and professional responsibility, we prepare healthcare professionals to deliver safe, respectful, and patient-centered care.', 'theme' => 'teal', 'icon' => 'M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.75c0 5.592 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.57-.598-3.75h-.152c-3.196 0-6.1-1.249-8.25-3.286zm0 13.036h.008v.008H12v-.008z'],
        ['title' => 'Excellence', 'text' => 'Excellence is the foundation of everything we do. We strive to deliver high-quality learning experiences, innovative educational programs, and competency-based training that meet global standards. Through continuous improvement and a commitment to quality, we empower healthcare professionals to achieve their full potential and provide outstanding care.', 'theme' => 'orange', 'icon' => 'M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z'],
        ['title' => 'Team Work', 'text' => 'Healthcare is built on collaboration. We value teamwork and encourage effective communication, mutual respect, and shared responsibility among learners, educators, healthcare professionals, and stakeholders. By working together, we create a supportive learning environment that enhances professional growth and improves healthcare outcomes.', 'theme' => 'teal', 'icon' => 'M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z'],
        ['title' => 'Integrity', 'text' => 'Integrity is essential to building trust and credibility. We conduct our work with honesty, transparency, accountability, and professionalism. We are committed to maintaining ethical practices in education, assessment, certification, and all organizational activities, ensuring confidence among our learners and partners.', 'theme' => 'orange', 'icon' => 'M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
        ['title' => 'Innovation', 'text' => 'We embrace innovation as a catalyst for growth and excellence. By leveraging technology, simulation-based learning, digital platforms, and evidence-based educational strategies, we continuously enhance the learning experience. We encourage creativity and adaptability to meet the evolving needs of healthcare education and practice.', 'theme' => 'teal', 'icon' => 'M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.383a14.406 14.406 0 01-3 0M14.25 18v-.192c0-.983.658-1.823 1.508-2.316a7.5 7.5 0 10-7.517 0c.85.493 1.509 1.333 1.509 2.316V18'],
        ['title' => 'Synergy', 'text' => 'We believe that meaningful collaboration creates greater impact. Through partnerships with healthcare institutions, educational organizations, professional bodies, and industry experts, we foster a culture of shared knowledge and collective success. Synergy enables us to achieve outcomes that exceed what can be accomplished individually.', 'theme' => 'orange', 'icon' => 'M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z'],
    ] as $value)
                        <div
                            class="relative flex flex-col items-center text-center bg-white p-6 sm:p-8 rounded-2xl border border-impetus-teal/10 shadow-sm transition hover:shadow-md hover:-translate-y-1 duration-300">
                            <div @class([
    ...
    <section class="relative border-b border-impetus-teal/10 bg-white py-16 sm:py-16">
        ...
        <div class="relative mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto mb-12 max-w-3xl text-center sm:mb-16">
                <h2
                    class="text-3xl font-extrabold uppercase tracking-widest !text-impetus-orange sm:text-4xl font-outfit">
                    Our Core Strengths
                </h2>
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                @foreach ([
        ['title' => 'Advanced Simulation Training', 'text' => 'Our realistic, simulation-based training programs provide healthcare learners with hands-on clinical experience in a safe, controlled environment. Through immersive practice and expert guidance, participants build essential clinical skills, critical thinking, confidence, and teamwork before delivering direct patient care in real healthcare settings.', 'icon' => 'M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 9.172V5L8 4z'],
        ['title' => 'Comprehensive Online Learning', 'text' => 'Our flexible online learning platform offers interactive courses, digital study materials, and competency-based assessments, enabling healthcare professionals to learn anytime, anywhere. Self-paced modules enhance clinical knowledge, strengthen professional competencies, and support continuous learning while accommodating individual schedules and career development needs.', 'icon' => 'M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z'],
        ['title' => 'Specialized Healthcare Programs', 'text' => 'We conduct specialized training across nursing and healthcare disciplines, including Basic Life Support, Health Assessment, Critical Care, Emergency Nursing, Airway Management, Neonatal Care, Infection Prevention and Control, and Advanced Clinical Skills, enhancing clinical competence, professional confidence, and quality patient care.', 'icon' => 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z'],
        ['title' => 'Industry-Relevant Curriculum', 'text' => 'Our training programs align with current healthcare standards, evidence-based practices, and professional competency requirements, equipping learners with practical, industry-relevant clinical skills that can be confidently applied in real healthcare settings to ensure safe, effective, and high-quality patient care.', 'icon' => 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.247 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253'],
        ['title' => 'Experienced Instructors', 'text' => 'Our training programs are led by qualified healthcare instructors, experienced clinicians, and industry professionals with extensive academic and clinical expertise, ensuring high-quality, competency-based learning, practical skill development, and evidence-informed education that prepares learners for excellence in modern healthcare practice.', 'icon' => 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z'],
        ['title' => 'Focus on Skill Development', 'text' => 'Our competency-based, outcome-oriented training enhances clinical knowledge, practical skills, and critical thinking to improve clinical decision-making, strengthen patient safety, build professional confidence, and prepare healthcare professionals to deliver high-quality, evidence-based care across diverse clinical practice settings.', 'icon' => 'M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138z'],
        ['title' => 'Technology-Driven Education', 'text' => 'We integrate modern educational technologies, including virtual classrooms, simulation-based learning, online assessments, digital certifications, and e-learning platforms, to deliver engaging learning experiences that enhance learner participation, knowledge retention, clinical competence, and continuous professional development for healthcare professionals.', 'icon' => 'M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z'],
        ['title' => 'Continuing Nursing Education', 'text' => 'We support lifelong learning through structured continuing education and skill enhancement programs that help healthcare professionals update clinical knowledge, strengthen competencies, adapt to evolving healthcare practices, maintain professional excellence, and achieve continuous career growth through flexible, learner-centered educational opportunities.', 'icon' => 'M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z'],
        ['title' => 'Commitment to Quality', 'text' => 'We are committed to strengthening healthcare workforce competence through high-quality education and training that enhances clinical knowledge, practical skills, and professional confidence, ultimately improving patient safety, healthcare quality, clinical outcomes, and excellence in healthcare service delivery across diverse practice settings.', 'icon' => 'M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138z'],
    ] as $strength)
                    @php
