...
@section('title', 'Online CNE Test - IHS')
            ...
            <div class="relative mx-auto max-w-7xl px-6 lg:px-8">
                <div class="grid items-center gap-16 lg:grid-cols-12">
                    <div class="lg:col-span-6">
                        <span
                            class="text-sm font-bold text-impetus-orange uppercase tracking-widest font-outfit mb-3 block">Competency
                            Assessment</span>
                        <h1
                    ...
                    <div class="lg:col-span-6 relative flex items-center justify-center">
                        ...
                        <div
                            class="relative overflow-hidden rounded-[2rem] border border-slate-200/80 bg-white p-3 shadow-2xl w-full max-w-[550px]">
                            <img src="{{ asset('images/66ccc0d0b5e3701731775c0c_652728a7077ae3384cfda548_Online20Proctoring20To20Cheating.png') }}"
                                alt="Online CNE Test and Proctoring"
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="grid items-stretch gap-16 lg:grid-cols-12">
                    ...
                    <div
                        ...
                        <div
                            class="w-12 h-12 rounded-2xl bg-impetus-navy text-white flex items-center justify-center shrink-0 mb-6 shadow-lg shadow-impetus-navy/20 relative z-10 animate-pulse">
                    ...
                    <div
                        ...
                        <h3 class="text-2xl sm:text-3xl font-extrabold text-impetus-navy font-outfit mb-4 relative z-10">
                            Benefits of Online CNE Test</h3>
                        <p class="text-base text-slate-500 leading-relaxed text-justify mb-6 relative z-10">
                        ...
                        <ul class="space-y-4 flex-grow relative z-10">
                            ...
                            <li
                                ...
                                <div>
                                    <h4 class="text-base font-bold text-impetus-navy font-outfit">Standardized Evaluation
                                    </h4>
                                    <p class="text-sm text-slate-500 mt-1 leading-relaxed">Provides objective and
                                        standardized assessment of learning.</p>
                                </div>
                            </li>
                            ...
                            <li
                                ...
                                <div>
                                    <h4 class="text-base font-bold text-impetus-navy font-outfit">Enhanced Accountability
                                    </h4>
                                    <p class="text-sm text-slate-500 mt-1 leading-relaxed">Enhances accountability in
                            ...
                            <li
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-slate-500 mt-1 leading-relaxed">Saves time and resources
                                        compared to traditional examinations.</p>
                                </div>
                            </li>
                            ...
                            <li
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-slate-500 mt-1 leading-relaxed">Allows participation from any
                                        location.</p>
                                </div>
                            </li>
                            ...
                            <li
                                ...
                                <div>
                                    <h4 class="text-base font-bold text-impetus-navy font-outfit">Continuous Progress
                                        Tracking</h4>
                                    <p class="text-sm text-slate-500 mt-1 leading-relaxed">Allows continuous monitoring of
                                        learning progress.</p>
                                </div>
                            </li>
                            ...
                            <li
                                ...
                                <div>
                                    <h4 class="text-base font-bold text-impetus-navy font-outfit">Self-Discipline Habits
                                    </h4>
                                    <p class="text-sm text-slate-500 mt-1 leading-relaxed">Encourages self-discipline and
                                        focused study habits.</p>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div
                        ...
                        <h4
                            ...
                            Fully Digital Access</h4>
                        <p class="text-base text-slate-600 leading-relaxed text-justify">
                            Fully digital and accessible through online platforms, eliminating physical test center
                            constraints.
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <h4
                            ...
                            Flexible Formats</h4>
                        <p class="text-base text-slate-600 leading-relaxed text-justify">
                            Choose between time-bound proctored models or highly flexible, self-paced competency
                            assessments.
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <h4
                            class="text-xl font-extrabold text-impetus-navy font-outfit mb-3 group-hover:text-impetus-orange transition-colors">
                            Automated Evaluation</h4>
                        <p class="text-base text-slate-600 leading-relaxed text-justify">
                            Instant results, interactive performance scorecards, and immediate feedback rationales are
                    ...
                    <div
                        ...
                        <h4
                            class="text-xl font-extrabold text-impetus-navy font-outfit mb-3 group-hover:text-impetus-orange transition-colors">
                            Integrity-Secured Portal</h4>
                        <p class="text-base text-slate-600 leading-relaxed text-justify">
                            Protected login portals and integrated proctoring workflows maintain assessment integrity at all
                            levels.
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M19.5 12c0-1.232-.046-2.453-.138-3.662a4.006 4.006 0 00-3.7-3.7 48.678 48.678 0 00-7.324 0 4.006 4.006 0 00-3.7 3.7C4.547 9.547 4.5 10.768 4.5 12s.047 2.453.138 3.662a4.006 4.006 0 003.7 3.7 48.656 48.656 0 007.324 0 4.006 4.006 0 003.7-3.7C19.453 14.453 19.5 13.232 19.5 12z" />
                            </svg>
                        </div>
                        <h4
                            class="text-xl font-extrabold text-impetus-navy font-outfit mb-3 group-hover:text-impetus-orange transition-colors">
                            Randomized Questions</h4>
                        <p class="text-base text-slate-600 leading-relaxed text-justify">
                            Each attempt dynamically shuffles the question pool and answers to ensure complete transparency
                            and fairness.
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <h4
                            class="text-xl font-extrabold text-impetus-navy font-outfit mb-3 group-hover:text-impetus-orange transition-colors">
                            Holistic Concept Coverage</h4>
                        <p class="text-base text-slate-600 leading-relaxed text-justify">
                            Comprehensive assessment mapped thoroughly to encompass both critical theory and practical
                            clinical decisions.
                        </p>
                    </div>
                </div>
        ...
        <section class="border-t border-slate-200/80 bg-white py-24 sm:py-32">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-3xl text-center mb-16">
                    <span
                        class="text-sm font-bold text-impetus-orange uppercase tracking-widest font-outfit mb-3 block">Rigorous
                        Taxonomy</span>
                    <h2 class="text-3xl sm:text-4xl font-extrabold text-impetus-navy tracking-tight font-outfit">
                ...
                <div class="grid gap-8 lg:grid-cols-3 lg:items-stretch">
                    ...
                    <article
                        ...
                        <div class="relative h-48 w-full shrink-0 overflow-hidden bg-slate-100">
                            <img src="{{ asset('images/factual-knowledge (1).jpeg') }}"
                            ...
                            <div class="absolute bottom-4 left-6 flex items-center gap-2">
                                <span
                                    class="rounded-full bg-white/20 px-3 py-1 text-xs font-bold text-white backdrop-blur-md border border-white/10 uppercase tracking-wide">Tier
                                    1</span>
                            </div>
                        </div>
                        <div class="flex min-h-0 flex-1 flex-col p-8">
                            <h3 class="text-2xl font-bold text-impetus-navy font-outfit mb-4">Level 1 - Factual Knowledge
                            </h3>
                            <div class="flex-1 space-y-4 text-base sm:text-lg text-slate-600 leading-relaxed text-justify">
                                <p>
                                    Focuses on the assessment of factual knowledge, evaluating the participant's
                                    foundational understanding of essential nursing concepts.
                                </p>
                                <p>
                                    Supports accurate evaluation of basic theoretical knowledge required for safe and
                                    effective clinical nursing practice.
                                </p>
                            </div>
                        </div>
                    </article>
                    ...
                    <!-- Level 2 Card -->
                    <article
                        class="flex h-full min-h-0 flex-col overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm transition-all hover:shadow-lg hover:-translate-y-1 border-t-4 border-t-impetus-navy group">
                        <div class="relative h-48 w-full shrink-0 overflow-hidden bg-slate-100">
                            <img src="{{ asset('images/factual-knowledge (2).jpeg') }}"
                        ...
                        <div class="flex min-h-0 flex-1 flex-col p-8">
                            <h3 class="text-2xl font-bold text-impetus-navy font-outfit mb-4">Level 2 - Functional
                                Knowledge</h3>
                            <div class="flex-1 space-y-4 text-base sm:text-lg text-slate-600 leading-relaxed text-justify">
                                <p>
                                    Focuses on the assessment of functional knowledge, measuring how well participants can
                                    apply learned concepts in practical nursing situations.
                                </p>
                                <p>
                                    Focuses directly on the clinical application of skills and safety protocols in
                    ...
                    <article
                        ...
                        <div class="relative h-48 w-full shrink-0 overflow-hidden bg-slate-100">
                            <img src="{{ asset('images/factual-knowledge (3).jpeg') }}"
                        ...
                        <div class="flex min-h-0 flex-1 flex-col p-8">
                            <h3 class="text-2xl font-bold text-impetus-navy font-outfit mb-4">Level 3 - Problem Solving
                            </h3>
                            <div class="flex-1 space-y-4 text-base sm:text-lg text-slate-600 leading-relaxed text-justify">
                                <p>
                                    Focuses on the assessment of problem-solving ability, challenging participants to use
                                    critical clinical judgement and decision-making in more complex scenarios.
                                </p>
                                <p>
                                    Recognizes higher-order reasoning, immediate diagnostics, and advanced clinical
                ...
                <div
                    class="mt-16 rounded-[2rem] border border-impetus-orange/20 border-l-8 border-l-impetus-orange bg-gradient-to-r from-impetus-orange/10 via-impetus-orange/[0.02] to-transparent p-8 sm:p-10 shadow-md">
                    <div class="flex flex-col sm:flex-row items-start gap-6">
                        <div
                            class="w-14 h-14 rounded-2xl bg-impetus-orange text-white flex items-center justify-center shrink-0 shadow-lg shadow-impetus-orange/25">
                            <svg class="w-7 h-7" fill="none" stroke="currentColor" stroke-width="2.5"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M12 7.5h1.5m-1.5 3h1.5m-7.5 3h7.5m-7.5 3h7.5m3-9h3.375c.621 0 1.125.504 1.125 1.125V18a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 18V6.125c0-.621.504-1.125 1.125-1.125H9.75M9 5.25h6.75m-6.75 0a.75.75 0 00-.75.75v1.125c0 .414.336.75.75.75h6.75a.75.75 0 00.75-.75V6c0-.414-.336-.75-.75-.75M9 5.25V3.75A1.5 1.5 0 007.5 2.25h9A1.5 1.5 0 0018 3.75V5.25" />
                            </svg>
                        </div>
                        <div>
                            <h4 class="text-xl sm:text-2xl font-extrabold text-impetus-navy font-outfit mb-3">Automated
                                Feedback &amp; Detailed Scoring Rationale</h4>
        ...
        <section class="py-20 sm:py-24 relative bg-impetus-navy text-white overflow-hidden">
            ...
            <div class="relative mx-auto max-w-5xl px-6 lg:px-8 text-center">
                <div
                    ...
                    <span class="text-xs sm:text-sm font-bold uppercase tracking-wider font-outfit text-slate-200">Outcome
                        Validation</span>
                </div>
