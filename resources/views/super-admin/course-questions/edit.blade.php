                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="question_level" name="question_level" required
                            ...
                            <option value="Level 3" {{ old('question_level', $question->question_level) == 'Level 3' ? 'selected' : '' }}>Level 3</option>
                        </select>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="question" name="question" rows="3" required
                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">{{ old('question', $question->question) }}</textarea>
                    ...
                    <template x-if="questionType === 'mcq'">
                        <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input id="choice_a" type="text" name="choice_a" value="{{ old('choice_a', $question->choice_a) }}"
                                    class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90" />
                            ...
                            <div>
                                ...
                                <input id="choice_b" type="text" name="choice_b" value="{{ old('choice_b', $question->choice_b) }}"
                                    class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90" />
                            ...
                            <div>
                                ...
                                <input id="choice_c" type="text" name="choice_c" value="{{ old('choice_c', $question->choice_c) }}"
                                    class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90" />
                            ...
                            <div>
                                ...
                                <input id="choice_d" type="text" name="choice_d" value="{{ old('choice_d', $question->choice_d) }}"
                                    class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90" />
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div x-show="questionType === 'mcq'">
                            <select id="answer_mcq" name="answer" :required="questionType === 'mcq'" :disabled="questionType !== 'mcq'"
                                ...
                                <option value="D" {{ old('answer', $question->answer) == 'D' ? 'selected' : '' }}>Choice D</option>
                            </select>
                        </div>
