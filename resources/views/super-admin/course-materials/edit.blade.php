                        ...
                        <div>
                            ...
                            <div
                                ...
                                @foreach ($material->attachment as $path)
                                    <div
                                        class="flex items-center gap-2 p-2 bg-white dark:bg-gray-800 rounded border border-gray-100 dark:border-gray-700 shadow-sm transition-all hover:border-brand-200">
                                        ...
                                        <a href="{{ asset('storage/' . $path) }}" target="_blank"
                                            class="text-xs text-gray-700 dark:text-gray-300 hover:text-brand-600 dark:hover:text-brand-400 truncate font-medium flex-1">
                                            {{ preg_replace('/^\d+_/', '', basename($path)) }}
                                        </a>
                                        <label
                                            class="inline-flex items-center gap-1 text-xs text-red-600 dark:text-red-400 whitespace-nowrap">
