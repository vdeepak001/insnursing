    ...
    <main class="relative isolate pb-20 sm:pb-28">
        <div class="pointer-events-none absolute inset-x-0 top-0 -z-10 h-[480px] overflow-hidden">
            ...
            <div class="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl" aria-hidden="true">
                <div class="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-logo-blue/15 to-impetus-orange/25 opacity-50 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
            </div>
        </div>
        ...
        <div class="mx-auto w-full max-w-2xl px-5 pt-28 sm:px-6 sm:pt-32 lg:px-8">
            ...
            <div class="mt-14 space-y-4" x-data="{ open: 0 }">
                <div class="overflow-hidden rounded-2xl border border-slate-200/90 bg-white/90 shadow-lg shadow-slate-200/50 ring-1 ring-slate-900/5 backdrop-blur-sm transition-shadow hover:shadow-xl hover:shadow-slate-300/40">
                    <button type="button" class="flex w-full items-start gap-4 px-5 py-5 text-left outline-none ring-0 focus:outline-none focus:ring-0 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-impetus-orange/40 sm:px-6 sm:py-6" @click="open = open === 0 ? null : 0" :aria-expanded="open === 0">
                        <span class="mt-0.5 flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-impetus-orange/20 to-impetus-orange/5 text-impetus-orange ring-1 ring-impetus-orange/20">
                        ...
                        <span class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-slate-100 text-slate-500 transition-transform duration-200" :class="open === 0 ? 'rotate-180 bg-impetus-orange/15 text-impetus-orange' : ''">
                ...
                <div class="overflow-hidden rounded-2xl border border-slate-200/90 bg-white/90 shadow-lg shadow-slate-200/50 ring-1 ring-slate-900/5 backdrop-blur-sm transition-shadow hover:shadow-xl hover:shadow-slate-300/40">
                    <button type="button" class="flex w-full items-start gap-4 px-5 py-5 text-left outline-none ring-0 focus:outline-none focus:ring-0 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-impetus-orange/40 sm:px-6 sm:py-6" @click="open = open === 1 ? null : 1" :aria-expanded="open === 1">
                        ...
                        <span class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-slate-100 text-slate-500 transition-transform duration-200" :class="open === 1 ? 'rotate-180 bg-impetus-orange/15 text-impetus-orange' : ''">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="h-5 w-5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                            </svg>
                        </span>
                ...
                <div class="overflow-hidden rounded-2xl border border-slate-200/90 bg-white/90 shadow-lg shadow-slate-200/50 ring-1 ring-slate-900/5 backdrop-blur-sm transition-shadow hover:shadow-xl hover:shadow-slate-300/40">
                    <button type="button" class="flex w-full items-start gap-4 px-5 py-5 text-left outline-none ring-0 focus:outline-none focus:ring-0 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-impetus-orange/40 sm:px-6 sm:py-6" @click="open = open === 2 ? null : 2" :aria-expanded="open === 2">
                        ...
                        <span class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-slate-100 text-slate-500 transition-transform duration-200" :class="open === 2 ? 'rotate-180 bg-impetus-orange/15 text-impetus-orange' : ''">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="h-5 w-5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                            </svg>
                        </span>
                ...
                <div class="overflow-hidden rounded-2xl border border-slate-200/90 bg-white/90 shadow-lg shadow-slate-200/50 ring-1 ring-slate-900/5 backdrop-blur-sm transition-shadow hover:shadow-xl hover:shadow-slate-300/40">
                    <button type="button" class="flex w-full items-start gap-4 px-5 py-5 text-left outline-none ring-0 focus:outline-none focus:ring-0 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-impetus-orange/40 sm:px-6 sm:py-6" @click="open = open === 3 ? null : 3" :aria-expanded="open === 3">
                        <span class="mt-0.5 flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-impetus-orange/20 to-impetus-orange/5 text-impetus-orange ring-1 ring-impetus-orange/20">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
                        ...
                        <span class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-slate-100 text-slate-500 transition-transform duration-200" :class="open === 3 ? 'rotate-180 bg-impetus-orange/15 text-impetus-orange' : ''">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="h-5 w-5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                            </svg>
                        </span>
                ...
                <div class="overflow-hidden rounded-2xl border border-slate-200/90 bg-white/90 shadow-lg shadow-slate-200/50 ring-1 ring-slate-900/5 backdrop-blur-sm transition-shadow hover:shadow-xl hover:shadow-slate-300/40">
                    <button type="button" class="flex w-full items-start gap-4 px-5 py-5 text-left outline-none ring-0 focus:outline-none focus:ring-0 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-impetus-orange/40 sm:px-6 sm:py-6" @click="open = open === 4 ? null : 4" :aria-expanded="open === 4">
                        <span class="mt-0.5 flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-logo-blue/15 to-logo-blue/5 text-logo-blue ring-1 ring-logo-blue/15">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
                        ...
                        <span class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-slate-100 text-slate-500 transition-transform duration-200" :class="open === 4 ? 'rotate-180 bg-impetus-orange/15 text-impetus-orange' : ''">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="h-5 w-5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                            </svg>
                        </span>
            ...
            <div class="mt-14 rounded-3xl border border-slate-200/80 bg-gradient-to-br from-brand-900 via-brand-900 to-brand-800 p-8 text-center shadow-2xl shadow-brand-900/25 sm:p-10">
                ...
                <div class="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
                    <a href="mailto:info@ihsnursing.com" class="inline-flex items-center justify-center rounded-full bg-impetus-orange px-6 py-3 text-sm font-bold text-white shadow-lg shadow-impetus-orange/30 transition hover:-translate-y-0.5 hover:shadow-xl hover:shadow-impetus-orange/40">
                        Email support
                    </a>
                </div>
            </div>
