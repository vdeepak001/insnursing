                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        <td style="padding: 24px;">
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0"
                                style="border: 1px solid #e2e8f0; border-radius: 12px; background-color: #f8fafc; margin-bottom: 24px; overflow: hidden; border-collapse: separate;">
                                <tr>
                                    <td
                                        style="padding: 16px; border-bottom: 1px solid #e2e8f0; font-size: 14px; color: #475569;">
                                        <strong
