<header
    class="sticky top-0 flex min-w-0 w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 xl:border-b"
    x-data="{
    ...
    <div class="flex flex-col grow xl:flex-row xl:px-6">
        <div class="flex items-center justify-between w-full h-full px-4 md:px-6 border-b border-gray-200 dark:border-gray-800 xl:border-b-0 xl:px-0">
