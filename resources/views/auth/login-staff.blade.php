            ...
            <div class="flex w-full flex-1 flex-col lg:w-1/2 bg-gradient-to-br from-slate-50 via-white to-slate-100/50 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900">
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center px-6 py-12 lg:px-8">
                    <div class="w-full bg-white/60 dark:bg-slate-900/40 backdrop-blur-xl p-8 sm:p-10 rounded-3xl border border-slate-200/50 dark:border-slate-800 shadow-xl shadow-slate-100/40 dark:shadow-none">
                        <div class="mb-8">
                            <span class="text-xs font-bold text-impetus-orange uppercase tracking-widest font-outfit mb-2 block">Administrative Portal</span>
                        ...
                        <div>
                            ...
                            <div class="mt-6">
                                <p class="text-center text-sm font-medium text-slate-600 dark:text-slate-400">
                                    <a href="{{ route('home') }}" class="font-bold text-impetus-orange hover:text-impetus-navy dark:text-orange-400 dark:hover:text-orange-300 transition-colors font-outfit font-medium">Back to site</a>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-gradient-to-br from-[#0F172A] via-[#1E293B] to-[#0F172A] relative hidden h-full w-full items-center justify-center lg:flex lg:w-1/2 overflow-hidden select-none">
                ...
                <div class="relative z-10 w-full max-w-sm p-10 bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2.5rem] shadow-2xl flex flex-col items-center text-center">
                    ...
                    <p class="text-sm text-slate-300 leading-relaxed max-w-[280px] font-outfit">
                        Secure access to the Impetus administrative dashboard and configuration engine.
                    </p>
